...
const configuration = new Configuration({
  apiKey: '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',
});
...
function man(){
    client.on('message', async message => {
        ...
        if(message.body.includes('*') || message.body.includes('.')) {
            ...
            console.log("Okey Wait I am Creating...!!")
            ...
            console.log("Hey, I am Jarvis ! RISHABH Sir Abhi busy hai");
        }
            ...
            console.log("*Hey, I am Jarvis. How Can I Help You?*");
        }
        ...
        else if (message.body.includes("good morning") || message.body.toLowerCase()=="gm") {
            message.reply("Good Morning Sir, How can i help you?");
            console.log("Good Morning Sir, How can i help you?");
        } 
            ...
            console.log("Good Afternoon Sir, How can i help you?");
        }   
        else if (message.body.includes("good evening") || message.body.toLowerCase()=="ge") {
            message.reply("Good Evening Sir, How can i help you?");
            console.log("Good Evening Sir, How can i help you?");
        }     
        else if (message.body.includes("good nigt") || message.body.toLowerCase()=="gn") {
            message.reply("Good Nigt Sir, How can i help you?");
            console.log("Good Nigt Sir, How can i help you?");
        }
        ...
        // else {
        //     console.log("*Welcome Sir Jarvis Added New Features*");
        // } 
    });
}
